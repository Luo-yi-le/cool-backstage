<template>
  <div class="public-account-management clearfix">
    ...
    <div class="left">
      ...
      <el-button class="save_btn" type="success" @click="saveFun"
        >保存并发布至菜单</el-button
      >
    </div>
    <!--右边配置-->
        ...
        <div>
          ...
          <div class="configur_content">
            <div class="material" v-if="tempObj.type == 'media_id'">
              ...
              ></el-input>
              <!--下面点击“选择素材”按钮，弹框框-->
              <el-popover placement="left" width="700" v-model="visible2">
              ...
              <p class="blue">
                tips:需要调后台获取到内容，弹框出来，然后选择，把名字赋值上去！
              </p>
            </div>
...
export default {
  ...
  methods: {
    ...
    async saveFun() {
      let con = await this.$api.saveOrUpdateMenu(this.menu.button);
      console.log(this.menu, con);
    },
    // 一级菜单点击事件
    menuFun(i, item) {
...
@import "~@/assets/style/wechat/menu.scss";
</style>
<!--修改UI框架样式-->
<style lang="scss">
